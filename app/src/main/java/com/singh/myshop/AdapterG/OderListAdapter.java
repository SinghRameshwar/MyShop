...
public class OderListAdapter extends BaseAdapter implements Filterable {

    public HashMap myList= new HashMap();
    public HashMap myListTemp= new HashMap();
    Context context;

    public OderListAdapter(Context context, HashMap myList) {
        super();
        this.myList=myList;
    ...
    public View getView(int i, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.item_order_cell, parent, false);
        }
        TextView itemName=(TextView)convertView.findViewById(R.id.itemName);
        TextView itemQty=(TextView)convertView.findViewById(R.id.itemQty);
        TextView cust_comment=(TextView)convertView.findViewById(R.id.cust_comment);
        ...
        itemName.setText("Item Name:- "+valueForFirstKey.get("itemName"));
        cust_comment.setText("Customer Mob:- "+valueForFirstKey.get("custMob"));
        try {
            itemQty.setText("Item Qty:- "+HelperClass.fractionDigits(Double.parseDouble(valueForFirstKey.get("itemQty"))));
        }catch (Exception e){}
